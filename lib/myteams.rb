...
class MyTeams
  ...
  def self.create_team(team_name:, number_of_players:, coach_or_manager:)
    DatabaseConnection.query("INSERT INTO my_teams (team_name, number_of_players, coach_or_manager) VALUES($1, $2, $3) RETURNING team_name, number_of_players, coach_or_manager;", [team_name, number_of_players, coach_or_manager]
      )
  end
