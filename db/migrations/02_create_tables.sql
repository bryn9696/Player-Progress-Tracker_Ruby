...
CREATE TABLE my_teams (id SERIAL PRIMARY KEY, user_id INTEGER REFERENCES users(id), team_name VARCHAR(60), number_of_players INTEGER, coach_or_manager VARCHAR(60));
